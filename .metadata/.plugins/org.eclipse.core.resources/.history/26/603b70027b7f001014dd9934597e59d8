...
public class Lab15 {
	  ...
	  public void f(String firstname,String lastname,String email_id,String phnumber,String password,String confirmpassword) throws InterruptedException {
			...
			obj.enterusername(firstname);
			obj.enterusername(lastname);
            obj.enterusername(email_id);
            obj.enterusername(phnumber);
			obj.enterpassword(password);
            obj.enterpassword(confirmpassword);
			obj.clickonlogin();
	  ...
	  public Object[][] dp() throws IOException, CsvException {
		...
		/*  
		  ...
		  */
		  ...
		  String csvFile = projectpath+"\\data3.csv";  // Path to your CSV file
